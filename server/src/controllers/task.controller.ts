...
//Kullanıcıya ait bütün taskları getirir
...
//Category bilgisine göre task getirir
...
// Task'ı complete ederek tamamlandığını gösterir
...
// ID bilgisine göre task silmeyi sağlar
export const deleteTask = async (request: AuthRequest, response: Response) => {
  try {
    ...
    console.log('Error in deleted task', error);
